...
static camera_desc* get_camera_device_desc(int fd, const char* devName)
{
    ...
    for(uint32_t i = 0; i < tuner_count; ++i) {
        ...
        camera->tuning[i].tuning_standard = (tuning_standard)tuner_info.audmode;
